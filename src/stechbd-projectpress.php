...
const ST_PROJECTPRESS_SITE_PLUGIN = ST_PROJECTPRESS_SITE . 'wp-content/plugins/stechbd-projectpress/';
const ST_PROJECTPRESS_SITE_CSS = ST_PROJECTPRESS_SITE_PLUGIN . 'asset/css/';
const ST_PROJECTPRESS_SITE_JS = ST_PROJECTPRESS_SITE_PLUGIN . 'asset/js/';
